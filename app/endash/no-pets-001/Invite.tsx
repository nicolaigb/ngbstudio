  ...
  <div className="space-y-5">
    ...
    <div className="flex flex-col items-center">
      <div className="w-full max-w-textContentWidth space-y-5">
        ...
        <P>
          The audio reactive visual is inspired by Tiago Canzian&apos;s tutorial
          found{' '}
        ...
        <P>
          P.S. We&apos;re not licensing Joy Orbison&apos;s chune of the year to
          play here. If you&apos;re Joy or from his team (sick) let us know and
          we&apos;ll take it down. Also, uuhhhh, pull up.
        </P>
      </div>
    </div>
  </div>
